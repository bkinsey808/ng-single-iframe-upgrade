...
const PACKAGE = `ng-single-iframe-upgrade`
const NPM_DIR = `dist`
...
shell.exec(`tslint --type-check -c tslint.json -t stylish src/**/*.ts`)
...
shell.exec(
  `rollup -i ${NPM_DIR}/${PACKAGE}.js -o ${MODULES_DIR}/${PACKAGE}.js --sourcemap`,
  { silent: true }
)
